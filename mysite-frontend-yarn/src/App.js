      ...
      <div>
        <Grid textAlign={"center"}>
          <Grid.Column width={9}>
            ...
            <p>I'm a FullStack Web Developer living in NYC. I used to travel around the world, chasing sunshine and exotic food, and now I'm in love with this city and here to stay.</p>
            <p><Link to='/travelphotos'>Travel Photos</Link></p>
            <p>
